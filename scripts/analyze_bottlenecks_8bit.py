...
files = {
    "Text-Only Baseline\n(pure text gen, no vision)":
        os.path.join(logs, "m2_text_baseline_20260419_005117_8bit.txt"),
    "Vision+Text (single image)\n(bench_8bit.zsh)":
        os.path.join(logs, "m2_trace_20260225_132943_8bit.txt"),
    "Video Inference (5 frames)\n(bench-vid_8bit.zsh)":
        os.path.join(logs, "m2_video_trace_20260419_001300_8bit.txt"),
}
...
plt.tight_layout()
out1 = os.path.join(base, "../data/processed_csvs", "fig1_power_timeline_phases_8bit.png")
...
plt.tight_layout()
out2 = os.path.join(base, "../data/processed_csvs", "fig2_gpu_freq_distribution_8bit.png")
...
plt.tight_layout()
out3 = os.path.join(base, "../data/processed_csvs", "fig3_alu_vs_bw_scatter_8bit.png")
...
plt.tight_layout()
out4 = os.path.join(base, "../data/processed_csvs", "fig4_bandwidth_saturation_8bit.png")
...
out5 = os.path.join(base, "../data/processed_csvs", "fig5_phase_transition_detail_8bit.png")
...
fig.suptitle("Cross-Workload Hardware Characterisation — Q8_0 (8-bit) InternVL2.5-4B",
...
plt.tight_layout()
out6 = os.path.join(base, "../data/processed_csvs", "fig6_cross_workload_comparison_8bit.png")
...
for label, df in datasets.items():
    ...
    out_csv = os.path.join(base, "../data/processed_csvs", f"enriched_{slug}_8bit.csv")
